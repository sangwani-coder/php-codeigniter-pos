                ...
                <form action="<?= base_url('register') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-0">
                            <input type="text" class="form-control rounded-0" id="name" name="name" autofocus placeholder="Pumulo Sepiso" value="<?= !empty($data->getPost('name')) ? $data->getPost('name') : '' ?>" required="required">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-0">
                            <input type="email" class="form-control rounded-0" id="email" name="email" placeholder="psepiso@email.com" value="<?= !empty($data->getPost('email')) ? $data->getPost('email') : '' ?>" required="required">
