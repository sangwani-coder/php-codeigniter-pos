            ...
            <form action="<?= base_url('Main/user_edit/'.(isset($user['id'])? $user['id'] : '')) ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group rounded-0">
                        <input type="text" class="form-control rounded-0" id="name" name="name" autofocus placeholder="Pumulo Sepiso" value="<?= !empty($user['name']) ? $user['name'] : '' ?>" required="required">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group rounded-0">
                        <input type="email" class="form-control rounded-0" id="email" name="email" placeholder="psepiso@email.com" value="<?= !empty($user['email']) ? $user['email'] : '' ?>" required="required">
